...
HyEngine::BillboardObject::~BillboardObject()
{
}

void HyEngine::BillboardObject::Initialize()
{
	TextureObject::Initialize();
}

void HyEngine::BillboardObject::Render()
{
...
D3DXMATRIX HyEngine::BillboardObject::CalcBillboardAll()
{
...
D3DXMATRIX HyEngine::BillboardObject::CalcBillboardX()
{
	D3DXMATRIX matView = CAMERA->GetViewMatrix();
...
D3DXMATRIX HyEngine::BillboardObject::CalcBillboardY()
{
	D3DXMATRIX matView = CAMERA->GetViewMatrix();
...
D3DXMATRIX HyEngine::BillboardObject::CalcBillboardZ()
{
	D3DXMATRIX matView = CAMERA->GetViewMatrix();
