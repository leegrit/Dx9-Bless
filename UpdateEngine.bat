...
xcopy			/y		.\HyEngine\Bin\Debug\*.lib		.\_Libraries\Debug\HyEngine\Lib\
xcopy			/y		.\HyEngine\Bin\Debug\*.dll		.\Client\Bin\Debug\
xcopy			/y		.\HyEngine\Include\*.h			.\_Libraries\Debug\HyEngine\Include\
xcopy			/y		.\HyEngine\Bin\Release\*.lib		.\_Libraries\Release\HyEngine\Lib\
xcopy			/y		.\HyEngine\Bin\Release\*.dll		.\Client\Bin\Release\
xcopy			/y		.\HyEngine\Include\*.h			.\_Libraries\Release\HyEngine\Include\