...
//class StateMachine;
//
//// Abstrat state base class that all states inherit from/
//class StateBase
//{
//public :
...
//
//
//// State action takes three template arguments 
//// A state machine class, a state function event data type (derived from eventData) 
//// and a state machine member function pointer
//template <class SM, class Data, void(SM::*Func)(const Data*)>
//class StateAction : public StateBase
//{
//public :
//	// StateBase::InvokeStateAction
